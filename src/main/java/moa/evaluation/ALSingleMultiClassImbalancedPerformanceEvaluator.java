 ...
 * @version $Revision: 7 $
 */
public class ALSingleMultiClassImbalancedPerformanceEvaluator extends MultiClassImbalancedPerformanceEvaluator implements ALClassificationPerformanceEvaluator {
    ...
    public Measurement[] getPerformanceMeasurements() {
        ...
        measurements[0] = new Measurement("Abs Number of Label Acquisitions", getAbsNumOfAcqInst());
        measurements[1] = new Measurement("Rel Number of Label Acquisitions", getRelNumOfAcqInst());
        return measurements;
    }
